...
const ExplanationBudget = () => {
  ...
  return (
    <View style={styles.explanationBudget}>
      <View style={[styles.theUserInputWasWhenClick, styles.frame2ShadowBox]}>
        ...
        <View style={styles.frame8}>
          <Text style={[styles.budget2024Aims, styles.budget2024AimsFlexBox]}>
            Budget 2024 aims to boost the economy and provide relief to the
            middle class. It introduces changes to income tax slabs, increases
            the standard deduction, and mandates tax clearance certificates for
            leaving India.
          </Text>
        </View>
        ...
        <View style={[styles.frame11, styles.frameLayout2]}>
          <Text style={[styles.budget2024Aims, styles.budget2024AimsFlexBox]}>
            The primary beneficiaries are the middle class who will benefit from
            tax relief, and the government which aims to increase tax collection
        ...
        <View style={[styles.frame14, styles.frameLayout2]}>
          <Text style={[styles.budget2024Aims, styles.budget2024AimsFlexBox]}>
            The budget aims to stimulate economic growth by putting more money
            in the hands of taxpayers. The new tax regime is expected to
            simplify tax filing and improve compliance.
          </Text>
        </View>
        ...
        <View style={[styles.frame17, styles.frameLayout2]}>
          <Text style={[styles.budget2024Aims, styles.budget2024AimsFlexBox]}>
            The immediate impact includes increased disposable income for the
            middle class due to tax benefits. Businesses may face challenges due
            to stricter tax compliance norms.
          </Text>
        </View>
        <Frame3 propTop={3} />
...
export default ExplanationBudget;
